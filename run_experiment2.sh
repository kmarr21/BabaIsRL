...
# run_experiment2.sh
# Script to run Experiment 2: KSM Comparison

echo "Starting Experiment 2: KSM Comparison"
echo "====================================="
...
EXP_DIR="experiments/experiment2"
...
run_with_retry() {
    ...
    # Build command (all configs use reward shaping and state augmentation)
...
echo "To generate plots, run: bash generate_plots.sh experiment2"
